...
let timeSpentNotification_NotifyTime = 10000; //10 seconds
...
function sendNotification(){
	timeSpentPopUp.close();
	$("#timeSpentPopUp_Contents")[0].innerHTML = "You have Spent " + Math.floor(timeSpentTimer/1000) + " seconds in place"
	timeSpentPopUp.open();
}
